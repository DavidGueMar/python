# Programa que da de alta de baja o lista coches
opcion = 0
coches = {}
max = 20
    ...
    if opcion == "1":
        if len(coches) < max:
            ...
            if not caracteristicas["Marca"] + caracteristicas["Modelo"] in coches:
                caracteristicas.update({"Cilindrada": input("Cilindrada?: "), "Potencia": input("Potencia?: "), "Velocidad Maxima": input("Velocidad Maxima?: ")})
